...
- **مالك النظام (`is_superuser`)**: إدارة المنصة كاملة — المدارس والاشتراكات والمدفوعات والشكاوى والدعم الفني.
...
### 4.3 إدارة المنصة
- لوحة إدارة المنصة وصفحاتها مقصورة على مالك النظام (`is_superuser`) وحده،
  ولا يوجد دور مفوَّض دونه.
