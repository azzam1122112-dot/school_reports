# منصة توثيق — تعريف وتسويق (Arabic)
...
### د) مدير النظام (System Admin / Superuser)
...
- **SchoolMembership**: يربط المستخدم بالمدرسة بدور (معلم/مدير). يدعم تعدد المدارس للحساب الواحد.
...
- إدارة المنصة: المدارس/المديرين/الباقات/الاشتراكات/المدفوعات/التذاكر.
...
- لوحة إدارة المنصة مقصورة على مالك النظام (`is_superuser`) وحده.
