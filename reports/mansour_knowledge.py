...
_FALLBACK_KNOWLEDGE_ITEMS = (
    ...
    KnowledgeItem(
        ...
        url="/archive/",
        text=(
            "الأرشيف السنوي إضافة يديرها مدير المدرسة. ينشئ نسخة ثابتة للسنة تشمل "
            "التقارير وملفات الإنجاز والطلبات والتعاميم والإشعارات وملفاتها المرتبطة، "
            "وتعرض كل نسخة أعداد السجلات والملفات والحجم وبصمة التحقق والتنزيلات."
        ),
    ...
    KnowledgeItem(
        ...
        url="/staff/export/",
        text=(
            "عند تفعيل الأرشيف يستطيع مدير المدرسة تصدير ملخص منظم لبيانات المدرسة "
            "وتنزيل حزمة الملفات المرتبطة. التصدير مخصص للمدير ويقتصر على المدرسة النشطة."
        ),
