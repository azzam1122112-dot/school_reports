...
_FALLBACK_KNOWLEDGE_ITEMS = (
    ...
    KnowledgeItem(
        ...
        text=(
            ...
            "المعلمين وسجل المدفوعات. الدفع الإلكتروني يفعّل الباقة والخدمات تلقائيًا "
            "فور تأكيد نجاح العملية، أما التحويل البنكي فيُراجع ويُفعّل خلال يوم عمل واحد كحد أقصى. "
            "بعد اعتماد الدفع تظهر فاتورة المنصة في صفحة الاشتراك وسجل المدفوعات، ويمكن عرضها أو تنزيلها PDF."
        ),
