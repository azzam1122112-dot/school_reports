...
SUBSCRIPTION_INCLUDED_FEATURES = (
    ...
    {
        "icon": "fa-database",
        "title": "مساحة تخزين تكبر مع فريقك",
        "detail": (
            "المساحة ليست رقماً موحداً لكل المدارس؛ تُحتسب من عدد المعلمين الذي "
            "تشتريه، فكلما كبر الفريق زادت المساحة. ويظهر لك حجمها بالضبط قبل الدفع."
        ),
    },
    {
        "icon": "fa-user-shield",
        "title": "صلاحيات وأدوار كاملة",
        "detail": "مدير المدرسة، مسؤول القسم، والمعلم — كل دور ببياناته وصلاحياته.",
    },
    {
        "icon": "fa-mobile-screen",
        "title": "إضافة المنصة لشاشة الجوال الرئيسية",
        "detail": (
            "المنصة تعمل من المتصفح على الجوال والحاسب، ويمكن إضافتها كأيقونة "
            "تفتح بملء الشاشة. لا يوجد تطبيق منفصل يُحمَّل من المتاجر."
        ),
    },
    {
        "icon": "fa-headphones",
